...
public class NotificationSettings {
    ...
    //public static String SenderId = "718228527870"; //QROO
    //public static String SenderId = "831487940857"; //JALA
    public static String SenderId = "253448751495"; //SanBlas
    ...
    //public static String HubName = "PGB_Jala_NotificationHub";
    public static String HubName = "PGB_SanBlas_NotificationHub";
    public static String HubListenConnectionString="Endpoint=sb://pgb-sanblas-notificationnamespace.servicebus.windows.net/;SharedAccessKeyName=DefaultFullSharedAccessSignature;SharedAccessKey=VFf/1vVP8D/Ossw44vZkKz5ThMkuYTGPZgoOHKZndRA=";
    //public static String HubListenConnectionString= "Endpoint=sb://pgbjalanotificationhubns.servicebus.windows.net/;SharedAccessKeyName=DefaultFullSharedAccessSignature;SharedAccessKey=UtccYiR5EyZBkUyeFoIkD7e/o0PHvVXzxht/2J2lTEM=";
