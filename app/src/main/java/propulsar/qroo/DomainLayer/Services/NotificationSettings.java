...
public class NotificationSettings {
    ...
    public static String SenderId = "928697845569";
    ...
    public static String HubName = "YoNayarit_NotificationHub";
    public static String HubListenConnectionString = "Endpoint=sb://yonayaritnamespace.servicebus.windows.net/;SharedAccessKeyName=DefaultFullSharedAccessSignature;SharedAccessKey=2uDDwNkBPDfqPwHQCxf9g+mEFiizdYphz7InKgAh0zA=";
