...
import propulsar.pgb.domainlayer.Adapters.EventsAdapter;
import propulsar.pgb.domainlayer.objects.AnalyticsApplication;
import propulsar.pgb.domainlayer.objects.Event;
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    TweetComposer.Builder builder = new TweetComposer.Builder(EventActivity.this)
                            .text(titleTweet+" "+Uri.parse(id)+" #"+getString(R.string.app_name));
